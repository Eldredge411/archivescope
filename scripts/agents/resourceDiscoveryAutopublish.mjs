...
function eCfrPartSeed({
  ...
  return {
    ...
    summaryShort: `${titleZhFull} 是 NARA 现行联邦文件管理法规的一部分，集中规定${focus}。它适合用作理解美国联邦文件管理制度的基础法规范本。`,
    summaryZh: `${titleZhFull} 收录在 eCFR 的 36 CFR Chapter XII 中，属于美国国家档案与文件署（NARA）管理联邦文件工作的现行法规文本。该部分围绕${focus}展开，说明联邦机构在文件形成、维护、处置、移交或保存中的合规要求。对中文用户来说，它比单条 Federal Register 修订公告更适合用于查看当前有效规则和制度框架。`,
    keyPoints: [
      `该资料来自 eCFR，是查看当前有效联邦法规文本的官方入口。`,
      `它对应 36 CFR 第 ${part} 部分，主题集中在${focus}。`,
      "可与 Federal Register 修订公告结合使用，用于区分“现行规则文本”和“历史修订过程”。",
      "适合档案法规、电子文件管理和联邦机构文件管理制度研究。", 
    ],
    researchValue: `该资料可用于研究美国联邦文件管理法规体系，尤其适合分析 NARA 如何通过 36 CFR 将联邦机构的文件创建、保存、处置、移交和长期保存要求制度化。中文档案学学习者可用它对照国内机关档案管理、电子文件管理和档案移交规范，理解法规层面对文件生命周期的具体控制方式。`,
...
function usCodeSeed({
  ...
  return {
    ...
    summaryShort: `${titleZh} 是美国档案、文件管理、信息公开或隐私制度的重要法律依据。它适合放在资料库中作为理解相关政策和法规的基础文本。`,
    summaryZh: `${titleZh} 是美国联邦法律体系中的基础资料，官方文本由 uscode.house.gov 提供。该资料重点涉及${focus}，为 NARA、联邦机构或公众获取政府信息的制度安排提供法律依据。将它作为独立条目收录，可以帮助用户从“法律基础”层面理解档案馆职责、联邦文件管理、总统文件、信息公开和隐私保护之间的关系。`,
    keyPoints: [
      "该资料来自美国法典官网，适合作为当前法律文本入口。",
      `核心内容涉及${focus}。`,
      "可与 eCFR 现行规章、NARA 指南和 Federal Register 修订公告配合阅读。",
      "适合用于美国档案法律制度、政府信息治理和公共文件制度研究。",
    ],
    researchValue: `该资料可用于搭建美国档案制度研究的法律框架，帮助中文用户理解联邦法律如何规定档案机构职责、文件管理义务、信息公开权利或个人信息保护边界。它也适合用于比较研究美国法典、行政规章和档案机构执行指南之间的层级关系。`,
    versioningApplicable: true,
    versionNote:
...
function policySeed({
  ...
  return {
    ...
    primaryTopicId,
    topicIds,
    tags: uniqueStrings(["NARA", "文件管理", ...tags]),
    summaryShort: `${titleZh} 是美国档案与文件管理领域的重要官方资料，聚焦${focus}。它可帮助用户快速理解相关政策要求、工具入口和实践背景。`,
    summaryZh: `${titleZh} 是面向联邦机构文件管理、电子文件转型或档案服务实践的官方资料。该资料围绕${focus}提供政策说明、执行路径或工具入口，适合作为学习美国档案治理和数字文件管理实践的基础材料。与单次公告相比，这类资料更接近日常业务指南或政策入口，便于用户从前台直接查阅和比较。`,
    keyPoints: [
      "该资料来自官方来源，适合优先作为学习和研究入口。",
      `内容重点围绕${focus}。`,
      "可与法律法规、eCFR 现行规则和 NARA 其他文件管理指南配合使用。",
      "适合用于理解美国联邦机构文件管理现代化和数字转型实践。",
    ],
    researchValue: `该资料可用于研究美国档案机构如何把法律法规转化为机构操作指南、数字化转型要求和具体业务工具。中文档案学学习者可据此观察 NARA 在电子文件、电子邮件、通用文件表、机构评估和长期保存方面的管理重点，并与国内相关制度和项目实践进行比较。`,
...
const eCfrSeeds = [
  eCfrPartSeed({
    ...
    focus: "NARA 处理个人隐私文件请求、信息披露、文件修正和特定文件系统豁免的程序规则",
  ...
  eCfrPartSeed({
    ...
    titleZh: "联邦文件管理总则",
    focus: "联邦文件的定义、机构职责和文件管理项目的总体要求",
    tags: ["联邦文件法", "总则"],
  }),
  eCfrPartSeed({
    part: "1222",
  ...
  eCfrPartSeed({
    ...
    titleZh: "文件非法或意外移除、污损、篡改与销毁",
    focus: "文件遭非法移除、篡改、损毁或意外丢失时的报告和补救责任",
    tags: ["文件安全", "文件丢失", "问责"],
  }),
  eCfrPartSeed({
    part: "1231",
  ...
  eCfrPartSeed({
    ...
    titleZh: "文件向存储设施转移",
    focus: "文件转入文件中心或存储设施时的条件、文件和管理要求",
    tags: ["文件中心", "存储设施"],
  }),
  eCfrPartSeed({
    part: "1233",
    ...
    titleZh: "总统图书馆文件的移交、利用与处置",
    focus: "总统图书馆体系中文件移交、利用和处置的制度安排",
  ...
  eCfrPartSeed({
    ...
    titleZh: "永久文件向国家档案馆移交",
    focus: "永久保存文件向国家档案馆移交的标准、时间和程序",
    tags: ["永久文件", "档案移交"],
  }),
  eCfrPartSeed({
    part: "1236",
    ...
    titleZh: "电子文件管理",
    focus: "电子文件、电子邮件、数字化副本和电子系统中的文件管理要求",
    tags: ["电子文件", "电子邮件", "数字化"],
  }),
  eCfrPartSeed({
    part: "1237",
    titleEn: "Audiovisual, Cartographic, and Related Records Management",
    titleZh: "视听、地图与相关文件管理",
    focus: "视听资料、地图资料、数字照片及相关特殊载体文件的管理",
    topicIds: ["digital-resources-preservation", "electronic-records-management"],
    tags: ["视听档案", "地图档案", "数字照片"],
  }),
  eCfrPartSeed({
    ...
    titleZh: "缩微文件管理",
    focus: "缩微文件制作、维护、质量控制和作为文件副本的管理要求",
    topicIds: ["digital-resources-preservation", "electronic-records-management"],
    tags: ["缩微文件", "介质管理"],
  }),
  eCfrPartSeed({
    ...
    titleZh: "文件管理项目协助与检查",
    focus: "NARA 对联邦机构文件管理项目的协助、评估和检查机制",
    tags: ["项目检查", "合规评估"],
  }),
];
...
const usCodeSeeds = [
  ...
  usCodeSeed({
    ...
    focus: "公众获取政府文件的权利、政府公开义务、豁免条款和行政救济机制",
  ...
  usCodeSeed({
    ...
    focus: "联邦机构个人信息文件系统、个人访问和更正权、文件披露限制",
    primaryTopicId: "laws-policies-governance",
    topicIds: ["laws-policies-governance", "access-outreach-public-participation"],
    tags: ["Privacy Act", "隐私保护", "个人信息", "文件系统"],
  }),
];
...
const ombSeeds = [
  policySeed({
    ...
    titleZh: "OMB/NARA M-12-18：政府文件管理指令",
    sourceUrl:
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "laws-policies-governance"],
    tags: ["OMB", "M-12-18", "电子文件", "政府文件管理"],
    focus: "联邦政府文件管理改革、电子邮件文件管理和数字化转型目标",
  ...
  policySeed({
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "laws-policies-governance"],
    tags: ["OMB", "M-14-16", "email records", "电子邮件文件"],
    focus: "联邦机构电子邮件文件的捕获、管理和 Capstone 管理方法",
    officialFileType: "pdf",
  }),
  policySeed({
    source: "omb",
    ...
    titleZh: "OMB/NARA M-19-21：向电子文件过渡",
    sourceUrl:
    ...
    tags: ["OMB", "M-19-21", "电子文件", "数字转型", "NARA"],
    focus: "联邦政府停止纸质文件移交、推进电子文件移交和电子档案管理现代化",
    officialFileType: "pdf",
  }),
  policySeed({
    source: "omb",
    ...
    titleZh: "OMB/NARA M-23-07：电子文件过渡更新",
    sourceUrl:
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "digital-resources-preservation"],
    tags: ["OMB", "M-23-07", "电子文件", "数字转型", "NARA"],
    focus: "更新联邦机构电子文件移交时限和数字化转型执行安排",
    officialFileType: "pdf",
  }),
];
...
const naraSeeds = [
  ...
  policySeed({
    ...
    titleZh: "NARA Bulletin 2014-04：永久电子文件移交格式指南",
    sourceUrl: "https://www.archives.gov/records-mgmt/bulletins/2014/2014-04.html",
    resourceType: "guidance",
    primaryTopicId: "digital-resources-preservation",
    topicIds: ["digital-resources-preservation", "electronic-records-management"],
    tags: ["NARA Bulletin", "电子文件移交", "文件格式", "永久文件", "数字保存"],
    focus: "永久电子文件移交到 NARA 时允许或推荐的文件格式、格式风险和长期保存要求",
    officialFileType: "html",
  }),
  policySeed({
    ...
    titleZh: "NARA Bulletin 2015-04：永久电子文件移交元数据指南",
    sourceUrl: "https://www.archives.gov/records-mgmt/bulletins/2015/2015-04.html",
    resourceType: "guidance",
    primaryTopicId: "digital-resources-preservation",
    topicIds: ["digital-resources-preservation", "electronic-records-management"],
    tags: ["NARA Bulletin", "元数据", "电子文件移交", "永久文件", "数字保存"],
    focus: "永久电子文件移交过程中的元数据字段、上下文信息和后续可发现性要求",
    officialFileType: "html",
  }),
  policySeed({
    ...
    titleZh: "NARA Bulletin 2020-01：向电子文件转型执行指南",
    sourceUrl: "https://www.archives.gov/records-mgmt/bulletins/2020/2020-01",
    resourceType: "guidance",
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "digital-resources-preservation"],
    tags: ["NARA Bulletin", "M-19-21", "电子文件转型", "无纸化移交", "数字政府"],
    focus: "联邦机构执行 M-19-21、停止纸质文件移交并转向电子文件管理的具体要求",
    officialFileType: "html",
  }),
  policySeed({
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "laws-policies-governance"],
    tags: ["NARA Bulletin", "Capstone", "电子消息", "电子邮件文件", "文件处置"],
    focus: "将 Capstone 方法从电子邮件扩展到聊天、即时通信和其他电子消息文件的管理",
    officialFileType: "html",
  }),
  policySeed({
    ...
    titleZh: "NARA Bulletin 2023-04：协作平台中的文件管理",
    ...
    tags: ["NARA Bulletin", "协作平台", "电子文件", "Teams", "Slack", "数字办公"],
    focus: "联邦机构在协作平台、聊天工具和数字办公系统中识别、捕获、保存和处置文件",
    officialFileType: "html",
  }),
  policySeed({
    ...
    titleZh: "NARA Bulletin 2025-01：涉密电子文件移交元数据指南",
    ...
    tags: ["NARA Bulletin", "涉密文件", "元数据", "电子文件移交", "长期保存"],
    focus: "涉密电子文件向 NARA 移交时的元数据、访问控制和长期保存上下文要求",
    officialFileType: "html",
  }),
  policySeed({
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "laws-policies-governance"],
    tags: ["records schedules", "文件控制表", "保管期限", "文件处置"],
    focus: "联邦机构文件控制表、处置授权和机构文件保管期限管理",
  }),
  policySeed({
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "laws-policies-governance"],
    tags: ["Capstone", "email records", "电子邮件文件", "文件管理"],
    focus: "以职位和账户角色为核心的电子邮件文件捕获、保管和处置方法",
  }),
  policySeed({
    id: "nara-electronic-records-archives-era",
    titleEn: "Electronic Records Archives",
    titleZh: "NARA 电子文件档案系统（ERA）",
    sourceUrl: "https://www.archives.gov/records-mgmt/era",
    resourceType: "system",
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "digital-resources-preservation"],
    tags: ["ERA", "电子文件档案", "文件移交", "系统"],
    focus: "联邦机构电子文件移交、处置请求和 NARA 电子文件档案系统使用",
  }),
  policySeed({
    ...
    primaryTopicId: "electronic-records-management",
    topicIds: ["electronic-records-management", "digital-resources-preservation"],
    tags: ["FRC", "联邦文件中心", "文件存储", "文件服务"],
    focus: "联邦文件中心网络、临时文件存储、检索服务和机构文件管理支持",
  }),
];
...
const socialEcosystemSeeds = [
  ...
  policySeed({
    ...
    tags: ["ARMA", "文件管理", "信息治理", "专业协会", "合规"],
    focus: "专业协会面向组织文件管理和信息治理提出的原则框架",
    versioningApplicable: false,
  }),
  policySeed({
    source: "docnow",
    ...
    focus: "社会媒体文件、社区参与式档案和数字时代资料采集伦理",
    versioningApplicable: false,
  }),
  policySeed({
    source: "cosa",
...
async function main() {
  ...
  const normalizedResourcesToAppend = normalizeRecordTerminology(resourcesToAppend);
  const normalizedEnrichmentsToAppend = normalizeRecordTerminology(enrichmentsToAppend);
  const normalizedOfficialFilesToAppend = normalizeRecordTerminology(officialFilesToAppend);

  await writeJson(acceptedResourcesPath, [
    ...safeAcceptedResources,
    ...normalizedResourcesToAppend,
  ]);
  await writeFile(
    resourceEnrichmentsPath,
    appendToTsArray(resourceEnrichmentsText, normalizedEnrichmentsToAppend),
    "utf8",
  );
  await writeFile(
    resourceOfficialFilesPath,
    appendToTsArray(resourceOfficialFilesText, normalizedOfficialFilesToAppend),
    "utf8",
  );
