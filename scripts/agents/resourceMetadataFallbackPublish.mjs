...
const topicLabels = {
  ...
  "electronic-records-management": "电子记录与记录管理",
...
const titleZhByResourceId = {
  ...
  "fr-04-5625": "联邦记录管理拟议监管框架",
  "fr-03-28454": "政府范围非采购禁止与暂停及无毒工作场所资助要求",
  "fr-03-26614": "联邦资助项目中残障歧视禁止规则拟议实施",
  "fr-02-16158": "通用记录表 24 信息技术运营与管理记录征求意见",
  "fr-02-15861": "国家历史出版物与记录委员会资助条例",
  "fr-01-12265": "记录处置技术性修订",
  "fr-01-8993": "约翰·F·肯尼迪遇刺记录收藏规则更正",
  "fr-00-20916": "联邦财政资助教育项目中的性别歧视禁止规则",
  "fr-99-30973": "机构记录中心规则",
  "fr-99-27372": "联邦资助教育项目中的性别歧视禁止拟议规则",
  "fr-99-24813": "机密国家安全信息保护规则",
  "fr-99-14382": "原通用记录表 20 所涵盖电子副本记录表征求意见",
  "fr-98-19469": "电子记录工作组报告草案征求意见",
  "fr-98-19466": "电子记录工作组报告草案附录 C",
  "fr-96-3097": "国家历史出版物与记录委员会资助项目程序",
  "fr-95-23818": "联邦记录处置拟议规则",
  "fr-95-13951": "重要记录管理规则",
  "fr-94-13517": "机构项目评估规则",
  "fr-94-13180": "重要记录灾害减缓与恢复规则",
  "fr-94-7187": "尼克松总统历史材料保存、保护与开放利用规则修订",
  "fr-04-10317": "官方印章与标识规则",
  "fr-02-4211": "研究阅览室程序规则",
  "fr-00-30178": "国家历史出版物与记录委员会 Title IX 适用项目通知",
...
function buildDraft(resource) {
  ...
  return {
    ...
    summaryZh: `该资料题为“${cleanString(resource.titleEn)}”，由美国国家档案与记录管理局（NARA）通过《联邦公报》发布${publishDate ? `，发布日期为 ${publishDate}` : ""}。作为${documentKind}，它反映了 NARA 在${themePhrase}方面的制度安排、程序要求或公开沟通。该条目用于为中文用户提供基础导读，帮助理解该资料在美国联邦档案治理、记录管理政策、公共服务规则或项目管理中的位置。后续如需正式引用，应以官方链接和联邦公报原文为准。`,
    keyPoints: [
...
async function main() {
  ...
  const fallbackDrafts = selectedResources.map(buildDraft);
