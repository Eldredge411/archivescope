...
import { InstitutionArchiveRoom } from "@/components/InstitutionArchiveRoom";
...
export default async function InstitutionDetailPage({
  ...
  return <InstitutionArchiveRoom institution={institution} resources={relatedResourceListItems} topics={relatedTopicsForInstitution} relatedInstitutions={relatedInstitutions}/>;
}
